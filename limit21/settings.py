"""
Django settings for limit21 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-!c3q!2!ma@o37uep=3-ixshodkj=hr&a1&h=vajl)^16+sr)qs')
...
WSGI_APPLICATION = 'limit21.wsgi.application'
